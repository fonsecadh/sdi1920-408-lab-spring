...
public class PO_NavView extends PO_View {
	...
	public static void clickOption(WebDriver driver, String textOption, String criterio, String textoDestino) {
		// CLicamos en la opción de registro y esperamos a que se cargue el enlace de
		// Registro.
	 ...
	 * 
	 * @param driver: apuntando al navegador abierto actualmente.
	 * @param textLanguae: el texto que aparece en el enlace de idioma ("English" o
	 *        "Spanish").
	 */
	public static void changeIdiom(WebDriver driver, String textLanguage) {
		// Clicamos la opción idioma
		...
		// Clicamos la opción Inglés partiendo de la opción Español
